...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsLoadingIndex = __webpack_require__(24);
	...
	new _vue2['default']({
		...
		mounted: function mounted() {
			...
			obserable.on('playVoice', function () {
				_this.$refs['bg'].play();
			});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _toastToast = __webpack_require__(18);
	...
	exports['default'] = {
		...
		methods: {
			longTapChange: function longTapChange(index) {
			...
			backtoShare: function backtoShare(e) {
	   ...
	   setTimeout(() => {
	   	this.touchend('',true);
			...
			showPrizePage: function showPrizePage() {
				//显示抽奖页面
				this.showPrize = true;
			},
			...
			touchstart: function touchstart(e) {
				...
				this.timer = setInterval(function () {
					...
					_this5.indexArr = _this5.indexArr.concat([]);
					console.log(_this5.iNow);
				}, 200);
				return false;
			},
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2019\\project\\newyear2019\\components\\toast\\toast.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-293c8e90&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-293c8e90&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
